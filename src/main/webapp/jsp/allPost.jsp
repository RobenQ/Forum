    ...
    <div class="main_r">
        <ul>
                ...
                <li>
                    ...
                    <c:forEach items="${userBlocks }" var="userBlock" varStatus="status" step="2">
                    	<tr>
                            <td><a href="/forum/user/block?block=${userBlock.blockName }">${userBlocks[status.count].blockName }</a></td>
                            <td><a href="/forum/user/block?block=${userBlock.blockName }">${userBlocks[status.count+1].blockName }</a></td>
                        </tr>
                    </c:forEach>
                    </table>
                </li>
